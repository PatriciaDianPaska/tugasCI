  ...
  <section id="container">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
            <a href="<?= base_url()?>index.html" class="logo"><b>TRAVELLING YUK!!!</b></a>
            <!--logo end-->
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?= base_url()?>login.html" style="font-colour:black;">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="<?= base_url()?>profile.html"><img src="<?=base_url()?>assets/img/me.jpg" class="img-circle" width="90" ></a></p>
              	  <h5 class="centered">Patricia Dian</h5>
              	  	
                    <li class="active">
                    <a href="<?=base_url('index.php/user')?>">
                        <p class="material-icons" ><img src="<?=base_url()?>assets/home.png" style="width: 30px;"><div style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Home</div></p>
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/profil.png"  style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Profil</div></p>
                      </a>
                  </li>

                  <li class="active">
                      <a href="<?=base_url('index.php/gallery')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/gallery.png"  style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Gallery</div></p>
                      </a>
                  </li>

                  <li class="active">
                      <a href="<?=base_url('index.php/event')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/event.png"  style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Event</div></p>
                      </a>
                  </li>
